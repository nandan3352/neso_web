...
const GlobalShareDialog = (props) => {
   const classes = useStyles()
    ...
    const share = [
        { Icon: Email, link: `mailto:?subject=${title}&body=check out this link ${shareUrl}.` },
        { Icon: Facebook, link: `https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&t=${title}` }, 
        { Icon: Twitter, link: `https://twitter.com/intent/tweet?url=${shareUrl}&text=${title}&hashtags=Nesoacademy,redefiningeducation` }, 
        { Icon: Whatsapp, link: `https://api.whatsapp.com/send/?phone&text=${title}, ${shareUrl}` }]
