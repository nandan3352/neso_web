...
function PPTLoadingDumb() {
    ...
    return (<Skeleton className='ppt-page-loading' variant='rect' height={dimension.height} width={dimension.width} />)

}

export default PPTLoadingDumb;